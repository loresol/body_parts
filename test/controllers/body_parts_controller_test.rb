...
class BodyPartsControllerTest < ActionController::TestCase
  ...
  test "should create body_part" do
    assert_difference('BodyPart.count') do
      post :create, body_part: { description: @body_part.description, name: @body_part.name, picture: @body_part.picture }
    end
  ...
  test "should update body_part" do
    patch :update, id: @body_part, body_part: { description: @body_part.description, name: @body_part.name, picture: @body_part.picture }
    assert_redirected_to body_part_path(assigns(:body_part))
  end
